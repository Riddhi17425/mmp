...
<section class="position-relative">
   <div class="video_banner">
      <video autoplay muted loop playsinline width="100%" class="mob_desk">
         <source src="<?php echo e(asset('public/front/images/Pleated_Filter_Bags_Verticle.mp4')); ?>" type="video/mp4">
         Your browser does not support the video tag.
      </video>
      <video autoplay muted loop playsinline width="100%" class="desk_vid">
         <source src="<?php echo e(asset('public/front/images/cta_vid_2.mp4')); ?>" type="video/mp4">
         Your browser does not support the video tag.
      </video>
      <!--<div class="col-lg-6">-->
...
<!--    <img src="<?php echo e(asset('public/Product_Banner_Images/'.$data['products']->product_banner_image)); ?>" alt="<?php echo e($data['products']->alt); ?>" class="img-fluid product-page-header" />-->
<!--    <div class="contact-head product-contact-head">-->
<!--              <h1><?php echo e($data['products']->product_name); ?></h1>-->
<!--              <div class="set-content">-->
...
<!--<video autoplay muted loop playsinline width="100%">-->
<!--         <source src="<?php echo e(asset('public/front/images/cta_video.mp4')); ?>" type="video/mp4">-->
<!--</video>-->
<!--</a>-->
<?php endif; ?>
   ...
   <div class="modal-dialog">
      <div class="modal-content">
         ...
         <div class="modal-body">
            ...
            <img class="img-fluid" src="<?php echo e(asset('public/front/images/ANTI MICROBIAL WOUND FILTER CARTRIDGE CERTIFICATE.png')); ?>" alt="image">
         </div>
      </div>
   </div>
</div>
      ...
      <div class="row">
         ...
         <div class="col-md-5">
            <div class="product-detail">
               <div><img src="<?php echo e(asset('public/front/images/data.png')); ?>" alt="Ordering Information" class="img-fluid" ></div>
            </div>
         </div>
      </div>
      <?php endif; ?>
   ...
   <div class="container">
      ...
      <div class="row">
         <div class="col-lg-4 col-md-6 col-sm-12 mb-3">
            <img src="<?php echo e(asset('public/front/images/ProductParameters.jpg')); ?>" alt="ProductParameters" class="img-fluid" />
         ...
         <div class="col-lg-4 col-md-6 col-sm-12 mb-3">
            <img src="<?php echo e(asset('public/front/images/ProductParameters1.jpg')); ?>" alt="ProductParameters" class="img-fluid" />
         ...
         <div class="col-lg-4 col-md-6 col-sm-12 mb-3">
            <img src="<?php echo e(asset('public/front/images/ProductParameters3.jpg')); ?>" alt="ProductParameters" class="img-fluid" />
         ...
         <div class="col-lg-4 col-md-6 col-sm-12 mb-3">
            <img src="<?php echo e(asset('public/front/images/ProductParameters4.jpg')); ?>" alt="ProductParameters" class="img-fluid" />
         ...
         <div class="col-lg-4 col-md-6 col-sm-12 mb-3">
            <img src="<?php echo e(asset('public/front/images/ProductParameters5.jpg')); ?>" alt="ProductParameters" class="img-fluid" />
         ...
         <div class="col-lg-4 col-md-6 col-sm-12 mb-3">
            <img src="<?php echo e(asset('public/front/images/ProductParameters9.jpg')); ?>" alt="ProductParameters" class="img-fluid" />
            <p class="short_dis text-center">
         ...
         <div class="col-lg-4 col-md-6 col-sm-12 mb-3">
            <img src="<?php echo e(asset('public/front/images/ProductParameters10.jpg')); ?>" alt="ProductParameters" class="img-fluid" />
            <p class="short_dis text-center">
         ...
         <div class="col-lg-4 col-md-6 col-sm-12 mb-3">
            <img src="<?php echo e(asset('public/front/images/ProductParameters12.jpg')); ?>" alt="ProductParameters" class="img-fluid" />
            <p class="short_dis text-center">
...
<section class="certificate-section">
   <div class="container">
      <div class="certificate-image-wrapper">
         ...
         <img class="img-fluid certificate-img" src="<?php echo e(asset('public/front/images/pleated-certificate.webp')); ?>" alt="certificate image">
      </div>
   </div>
</section>
<?php endif; ?>

<?php if(isset($data['products']->faq) && !empty($data['products']->faq)): ?>
<section class="Product-detail-faq">
   <div class="container">
      ...
      <?php endif; ?>
      <!--<h3 class="inner-head">FAQs About <?php echo e($data['products']->product_name); ?>-->
      <!--</h3>-->
      <h3 class="inner-head"><?php if($data['products']->product_name == 'Dust Collector Filter Bags'): ?>
         <?php echo e('FAQs About Dust Collector Bags'); ?>

         <?php else: ?>
         FAQs About <?php echo e($data['products']->product_name); ?>
      ...
      <div class="accordion accordion-flush" id="accordionFlushExample">
         ...
         <div class="accordion-item">
            <h4 class="accordion-header" id="flush-heading<?php echo e($index + 1); ?>">
               <button class="accordion-button <?php echo e($index === 0 ? '' : 'collapsed'); ?>" type="button" data-bs-toggle="collapse" data-bs-target="#flush-collapse<?php echo e($index + 1); ?>" aria-expanded="<?php echo e($index === 0 ? 'true' : 'false'); ?>" aria-controls="flush-collapse<?php echo e($index + 1); ?>">
               <?php echo $faq->question; ?>

               </button>
            </h4>
            <div id="flush-collapse<?php echo e($index + 1); ?>" class="accordion-collapse collapse <?php echo e($index === 0 ? 'show' : ''); ?>" aria-labelledby="flush-heading<?php echo e($index + 1); ?>" data-bs-parent="#accordionFlushExample">
         ...
         <div class="row">
            ...
            <div class="col-xl-3 col-md-12 col-sm-6">
               <div class="mrb-image-position">
                  <img src="<?php echo e(asset('public/front/images/mrb-images/mrb-series.png')); ?>" class="mrb-img" >
               </div>
            </div>
         </div>
      </div>
   ...
   <div class="container">
      <div class="row">
         <div class="col-xl-7 col-md-12 col-sm-12">
            <img src="<?php echo e(asset('public/front/images/mrb-images/left-imge-mrb.png')); ?>" class="img-fluid">
         </div>
            ...
            <div class="industries-box">
               <div class="row d-flex">
                  <div class="col-xl-3 col-md-3 col-sm-4">
                     <img src="<?php echo e(asset('public/front/images/mrb-images/chemical-icon.png')); ?>" class="img-fluid">
                     <p class="mrb-pera">Chemical</p>
                  </div>
                  <div class="col-xl-3 col-md-3 col-sm-4">
                     <img src="<?php echo e(asset('public/front/images/mrb-images/petro-icon.png')); ?>" class="img-fluid">
                     <p class="mrb-pera">Petrochemicals</p>
                  </div>
                  <div class="col-xl-3 col-md-3 col-sm-4">
                     <img src="<?php echo e(asset('public/front/images/mrb-images/paints-icon.png')); ?>" class="img-fluid">
                     <p class="mrb-pera">Paints</p>
                  </div>
                  <div class="col-xl-3 col-md-3 col-sm-4">
                     <img src="<?php echo e(asset('public/front/images/mrb-images/coating-icon.png')); ?>" class="img-fluid">
                     <p class="mrb-pera">Coatings</p>
                  </div>
                  <div class="col-xl-3 col-md-3 col-sm-4">
                     <img src="<?php echo e(asset('public/front/images/mrb-images/food-icon.png')); ?>" class="img-fluid">
                     <p class="mrb-pera">Food</p>
                  </div>
                  <div class="col-xl-3 col-md-3 col-sm-4">
                     <img src="<?php echo e(asset('public/front/images/mrb-images/baverage-icon.png')); ?>" class="img-fluid">
                     <p class="mrb-pera">Beverages</p>
                  </div>
                  <div class="col-xl-3 col-md-3 col-sm-4">
                     <img src="<?php echo e(asset('public/front/images/mrb-images/auto-icon.png')); ?>" class="img-fluid">
   ...
   <div class="container">
      ...
      <div class="back-set">
         <div class="row">
            ...
            <div class="col-xl-3 col-md-6 col-sm-6">
               <div class="mid-box">
                  <img src="<?php echo e(asset('public/front/images/mab-images/mab-pendulam.png')); ?>" class="mad-img-pandulam" >
                  <p class="mrb-pera text-center text-white">Cross-sectional view for
            ...
            <div class="col-xl-3 col-md-12 col-sm-6">
               <div class="mrb-image-position">
                  <img src="<?php echo e(asset('public/front/images/mab-images/mab-series.png')); ?>" class="mab-img" >
               </div>
            </div>
         </div>
      </div>
...
<section class="industries-wrapper">
   <div class="container">
      <div class="row">
         <div class="col-xl-7 col-md-12 col-sm-12">
            <img src="<?php echo e(asset('public/front/images/mab-images/mab-left-img.png')); ?>" class="img-fluid">
         </div>
         <div class="col-xl-5 col-md-12 col-sm-12">
            <h2 class="mrb-head">Use of Product in Various Industries</h2>
            <div class="industries-box">
   ...
   <div class="container">
      <div class="row">
         ...
         <div class="col-md-5 mb-4">
            <div class="product-detail">
               <div><img src="<?php echo e(asset('public/front/images/Electromechanical-Winding-Machines.webp')); ?>" alt="Wound Filter" class="img-fluid" ></div>
            </div>
         </div>
         ...
         <!-- <div class="col-md-7">-->
         <!--        <div><img src="<?php echo e(asset('public/front/images/WoundFilter_table.png')); ?>" alt="" class="img-fluid" ></div>-->
         <!--</div>-->
      ...
      <!--        <div class="product-detail">-->
      <!--            <div class="manufacturing">-->
      <!--                    <div><img src="<?php echo e(asset('public/front/images/Smartwind-360-Fully-Automatic-Multi-Layer-Winding-Machine.webp')); ?>" alt="Wound Filter"-->
      <!--                    class="img-fluid"></div>-->
      <!--<div>-->
      <!--   <img src="<?php echo e(asset('public/front/images/3rd_3spindle_Machine.jpg')); ?>" alt="Wound Filter" class="img-fluid" >-->
      <!--</div>-->
      <!--<div>-->
      <!--   <img src="<?php echo e(asset('public/front/images/3rd_2spindle_Machine.jpg')); ?>" alt="Wound Filter" class="img-fluid" >-->
      <!--</div>-->
      <!--            </div>-->
      <!--        </div>-->
      <!--    </div>-->
