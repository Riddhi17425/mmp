...
<div class="ft_eq_btn" id="eq_btn">
    ...
    <img src="<?php echo e(asset('public/newpublic/images/enquire-now-btn.webp')); ?>" alt="enquire-now" class="img-fluid" height="100" width="100">
        <!-- Hidden Div -->
    ...
    <div class="popup-content">
        ...
        <form method="post" action="<?php echo e(route('headerinquiry')); ?>" id="headerinquiry1" class="p-3" novalidate autocomplete="off">
            <?php echo csrf_field(); ?>
            ...
            <div class="mb-2">
                <select name="product_type" id="product_type">
                    ...
                    <?php $__currentLoopData = $product; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $productname): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($productname->product_name); ?>"><?php echo e($productname->product_name); ?></option>
            ...
            <div class="mb-2">
                <label>
                    What is <span id="capA"><?php echo e($a); ?></span> + <span id="capB"><?php echo e($b); ?></span> ?
                </label>
                ...
                <input type="hidden" name="captcha_sum" id="captcha_sum" value="<?php echo e($a + $b); ?>">
...
</script><?php /**PATH C:\Intelliworkz\mmp\resources\views/layouts/enquire-poup.blade.php ENDPATH**/ ?>