    ...
    <div class="hero-slider">
        ...
        <div>
            ...
            <div class="hero_wrapper">
                ...
                <!-- <img loading="lazy"src="<?php echo e(asset('public/newpublic/images/hero_1.png')); ?>" alt="mmp" class="img-fluid hero_img"> -->

                <picture>

                    <source media="(max-width:465px)" srcset="<?php echo e(asset('public/newpublic/images/pp-yarn-m.webp')); ?>">

                    <img loading="eager" src="<?php echo e(asset('public/newpublic/images/PP-YARN-EXCELLENCE.webp')); ?>" alt="ppyarn" class="img-fluid hero_img">
                ...
                <div class="hero_content">
                    ...
                    <div class="hero_title">
                        ...
                        <div class="btn_wrapper">
                            ...
                            <a href="<?php echo e(url('contact')); ?>" class="btn_3">
                            ...
                            <a href="<?php echo e(url('product-detail/polypropylene-yarns')); ?>" class="btn_3">
        ...
        <div>
            ...
            <div class="hero_wrapper">
                ...
                <picture>
                    ...
                    <source media="(max-width:465px)" srcset="<?php echo e(asset('public/newpublic/images/water-filter-m.webp')); ?>">

                    <img loading="eager" src="<?php echo e(asset('public/newpublic/images/Water-Filter-Cartridges.webp')); ?>" alt="water filter" class="img-fluid hero_img">
                ...
                <div class="hero_content">
                    ...
                    <div class="hero_title">
                        ...
                        <div class="btn_wrapper">
                            ...
                            <a href="<?php echo e(url('product/water-filter-cartridges')); ?>" class="btn_3">
        ...
        <div>
            ...
            <div class="hero_wrapper">
                ...
                <picture>
                    ...
                    <source media="(max-width:465px)" srcset="<?php echo e(asset('public/newpublic/images/air-filter-m.webp')); ?>">

                    <img loading="eager" src="<?php echo e(asset('public/newpublic/images/Air-Filter-Cartridges.webp')); ?>" alt="air filter" class="img-fluid hero_img">
                ...
                <div class="hero_content">
                    ...
                    <div class="hero_title">
                        ...
                        <div class="btn_wrapper">
                            ...
                            <a href="<?php echo e(url('product/air-filter-cartridges')); ?>" class="btn_3">
        ...
        <div>
            ...
            <div class="hero_wrapper">
                ...
                <picture>
                    ...
                    <source media="(max-width:465px)" srcset="<?php echo e(asset('public/newpublic/images/Wound-Filter-Machine-m.webp')); ?>">

                    <img loading="eager" src="<?php echo e(asset('public/newpublic/images/Wound_Filter_Machine.webp')); ?>" alt="Wound Filter Machine" class="img-fluid hero_img">
                ...
                <div class="hero_content">
                    ...
                    <div class="hero_title">
                        ...
                        <div class="btn_wrapper">
                            ...
                            <a href="<?php echo e(url('wound-filter-cartridge-machine')); ?>" class="btn_3">
    ...
    <div class="ym-container">
        ...
        <div class="our_patent_wrapper">
            ...
            <div>
                ...
                <div class="patent_slider">
                    ...
                    <div>
                        ...
                        <img loading="lazy" src="<?php echo e(asset('public/newpublic/images/hw.png')); ?>" alt="hydro wound" class="img-fluid">

                    </div>

                    <div>

                        <img loading="lazy" src="<?php echo e(asset('public/newpublic/images/lagon.png')); ?>" alt="hydro wound" class="img-fluid">

                    </div>

                    <div>

                        <img loading="lazy" src="<?php echo e(asset('public/newpublic/images/ocean.png')); ?>" alt="hydro wound" class="img-fluid">

                    </div>

                    <div>

                        <img loading="lazy" src="<?php echo e(asset('public/newpublic/images/mtex.png')); ?>" alt="hydro wound" class="img-fluid">

                    </div>

                    <div>

                        <img loading="lazy" src="<?php echo e(asset('public/newpublic/images/Pleatex.png')); ?>" alt="hydro wound" class="img-fluid">

                    </div>

                    <div>

                        <img loading="lazy" src="<?php echo e(asset('public/newpublic/images/pyoorote.png')); ?>" alt="hydro wound" class="img-fluid">
            ...
            <div>
                ...
                <img loading="lazy" src="<?php echo e(asset('public/newpublic/images/nsf.webp')); ?>" alt="Our Patented Brands" class="img-fluid">
    ...
    <div class="ym-container">
        ...
        <div class="home_about_grid">
            ...
            <div class="home_abt_left">
                ...
                <img loading="lazy" src="<?php echo e(asset('public/newpublic/images/home_about.png')); ?>" alt="Advanced Filtration Solutions" class="img-fluid h-100">
        ...
        <div class="title_head">
            ...
            <div class="row top_title">
                ...
                <div class="col">
                    ...
                    <a href="<?php echo e(url('product/water-filter-cartridges')); ?>" class="btn_1">View All</a>
                        ...
                        <div class="home_water_slide">
                            ...
                            <div>
                                ...
                                <img loading="lazy"
                                     ...
                                     src="<?php echo e(asset('public/Product_Images/melt-blown-filter-cartridges.jpg')); ?>"
                            ...
                            <div>
                                ...
                                <a href="<?php echo e(url('product-detail/melt-blown-filter-cartridges')); ?>">
                        ...
                        <div class="home_water_slide">
                            ...
                            <div>
                                ...
                                <img loading="lazy"
                                     ...
                                     src="<?php echo e(asset('public/Product_Images/wound-filter-cartridges%20(1).jpg')); ?>"
                            ...
                            <div>
                                ...
                                <a href="<?php echo e(url('product-detail/wound-filter-cartridges')); ?>">
                        ...
                        <div class="home_water_slide">
                            ...
                            <div>
                                ...
                                <img loading="lazy"
                                     ...
                                     src="<?php echo e(asset('public/Product_Images/Core-for-filter-Cartridges.jpg')); ?>"
                            ...
                            <div>
                                ...
                                <a href="<?php echo e(url('product-detail/core-for-filter-cartridge')); ?>">
                        ...
                        <div class="home_water_slide">
                            ...
                            <div>
                                ...
                                <img loading="lazy"
                                     ...
                                     src="<?php echo e(asset('public/Product_Images/wound-filter-machine.jpg')); ?>"
                            ...
                            <div>
                                ...
                                <a href="<?php echo e(url('product-detail/wound-filter-machine')); ?>">
                        ...
                        <div class="home_water_slide">
                            ...
                            <div>
                                ...
                                <img loading="lazy"
                                     ...
                                     src="<?php echo e(asset('public/Product_Images/highflow-product.jpg')); ?>"
                            ...
                            <div>
                                ...
                                <a href="<?php echo e(url('product-detail/high-flow-pleated-filter')); ?>">
                        ...
                        <div class="home_water_slide">
                            ...
                            <div>
                                ...
                                <img loading="lazy"
                                     ...
                                     src="<?php echo e(asset('public/Product_Images/pp-pleated-filter-cartridges.jpg')); ?>"
                            ...
                            <div>
                                ...
                                <a href="<?php echo e(url('product-detail/pp-pleated-filter-cartridges')); ?>">
                        ...
                        <div class="home_water_slide">
                            ...
                            <div>
                                ...
                                <img loading="lazy"
                                     ...
                                     src="<?php echo e(asset('public/Product_Images/PPH-PVDF-One-Piece-Filter_2.jpg')); ?>"
                            ...
                            <div>
                                ...
                                <a href="<?php echo e(url('product-detail/pph-one-piece-filter-housing')); ?>">
                        ...
                        <div class="home_water_slide">
                            ...
                            <div>
                                ...
                                <img loading="lazy"
                                     ...
                                     src="<?php echo e(asset('public/Product_Images/mrb-product-img.jpg')); ?>"
                            ...
                            <div>
                                ...
                                <a href="<?php echo e(url('product-detail/resin-bonded-filter-cartridges')); ?>">
                        ...
                        <div class="home_water_slide">
                            ...
                            <div>
                                ...
                                <img loading="lazy"
                                     ...
                                     src="<?php echo e(asset('public/Product_Images/mab-product.jpg')); ?>"
                            ...
                            <div>
                                ...
                                <a href="<?php echo e(url('product-detail/grooved-resin-bonded-filter-cartridges')); ?>">
                        ...
                        <div class="home_water_slide">
                            ...
                            <div>
                                ...
                                <img loading="lazy"
                                     ...
                                     src="<?php echo e(asset('public/Product_Images/anti_microbial_cartidage.png')); ?>"
                            ...
                            <div>
                                ...
                                <a href="<?php echo e(url('product-detail/anti-microbial-wound-filter-cartridges')); ?>">
    ...
    <div class="ym-container">
        ...
        <div class="title_head">
            ...
            <div class="row top_title">
                ...
                <div class="col">
                    ...
                    <a href="<?php echo e(url('product/air-filter-cartridges')); ?>" class="btn_1">View All</a>
        ...
        <div class="home_water_wrapper">
            ...
            <div class="home_water_slider">
                ...
                <?php $__currentLoopData = $data['airProducts']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <div class="home_water_slide">
                            ...
                            <div>
                                ...
                                <img loading="lazy"
                                     ...
                                     alt="<?php echo e($item->product_alt ?? $item->product_name); ?>"
                            ...
                            <div>
                                ...
                                <a href="<?php echo e(url('product-detail/' . $item->producturl)); ?>">

                                    <h4 class="title_20"><?php echo e($item->product_name); ?></h4>
    ...
    <div class="ym-container">
        ...
        <div class="iws_1">
            ...
            <div class="iws_box">
                ...
                <img loading="lazy" src="<?php echo e(asset('public/newpublic/images/iws-pharma.svg')); ?>" alt="Pharma" height="70" width="70">
                ...
                <div class="d-flex align-items-center justify-content-between">
                    ...
                    <div class="styled-wrapper">
                        ...
                        <a href="<?php echo e(url('pharma-industry')); ?>">
            ...
            <div class="iws_box">
                ...
                <img loading="lazy" src="<?php echo e(asset('public/newpublic/images/iws-chemical.svg')); ?>" alt="Chemical" height="70" width="70">
                ...
                <div class="d-flex align-items-center justify-content-between">
                    ...
                    <div class="styled-wrapper">
                        ...
                        <a href="<?php echo e(url('chemical-industry')); ?>">
            ...
            <div class="iws_box">
                ...
                <img loading="lazy" src="<?php echo e(asset('public/newpublic/images/iws-water-treatment.svg')); ?>" alt="Water-Treatment" height="70" width="70">
                ...
                <div class="d-flex align-items-center justify-content-between">
                    ...
                    <div class="styled-wrapper">
                        ...
                        <a href="<?php echo e(url('water-treatment-industry')); ?>">
            ...
            <div class="iws_box">
                ...
                <img loading="lazy" src="<?php echo e(asset('public/newpublic/images/iws-food&bevrages.svg')); ?>" alt="Food & Beverages" height="70" width="70">
                ...
                <div class="d-flex align-items-center justify-content-between">
                    ...
                    <div class="styled-wrapper">
                        ...
                        <a href="<?php echo e(url('food-and-beverage-industry')); ?>">
            ...
            <div class="iws_box">
                ...
                <img loading="lazy" src="<?php echo e(asset('public/newpublic/images/iws-textile.svg')); ?>" alt="Textile" height="70" width="70">
                ...
                <div class="d-flex align-items-center justify-content-between">
                    ...
                    <div class="styled-wrapper">
                        ...
                        <a href="<?php echo e(url('textile-industry')); ?>">
        ...
        <div class="iws_2">
            ...
            <div class="iws_box">
                ...
                <img loading="lazy" src="<?php echo e(asset('public/newpublic/images/iws-dairy.svg')); ?>" alt="Dairy" height="70" width="70">
                ...
                <div class="d-flex align-items-center justify-content-between">
                    ...
                    <div class="styled-wrapper">
                        ...
                        <a href="<?php echo e(url('dairy-industry')); ?>">
            ...
            <div class="iws_box">
                ...
                <img loading="lazy" src="<?php echo e(asset('public/newpublic/images/iws-oil&gas.svg')); ?>" alt="Oil & Gas" height="70" width="70">
                ...
                <div class="d-flex align-items-center justify-content-between">
                    ...
                    <div class="styled-wrapper">
                        ...
                        <a href="<?php echo e(url('oilandgas-industry')); ?>">
            ...
            <div class="iws_box">
                ...
                <img loading="lazy" src="<?php echo e(asset('public/newpublic/images/iws-cement.svg')); ?>" alt="Cement" height="70" width="70">
                ...
                <div class="d-flex align-items-center justify-content-between">
                    ...
                    <div class="styled-wrapper">
                        ...
                        <a href="<?php echo e(url('cement-industry')); ?>">
            ...
            <div class="iws_box">
                ...
                <img loading="lazy" src="<?php echo e(asset('public/newpublic/images/iws-poer-plant.svg')); ?>" alt="Power Plant" height="70" width="70">
                ...
                <div class="d-flex align-items-center justify-content-between">
                    ...
                    <div class="styled-wrapper">
                        ...
                        <a href="<?php echo e(url('power-plant-industry')); ?>">
    ...
    <div class="ym-container">
        ...
        <div class="usp_grid">
            ...
            <div class="usp_grid_box">
                ...
                <img loading="lazy" src="<?php echo e(asset('public/newpublic/images/usp1.svg')); ?>" alt="usp" height="60" width="60">
            ...
            <div class="usp_grid_box">
                ...
                <img style="object-fit: contain; width:fit-content" loading="lazy" src="<?php echo e(asset('public/newpublic/images/nsf.webp')); ?>" alt="usp" height="60">
            ...
            <div class="usp_grid_box">
                ...
                <img loading="lazy" src="<?php echo e(asset('public/newpublic/images/usp3.svg')); ?>" alt="usp" height="60" width="60">
            ...
            <div class="usp_grid_box">
                ...
                <img loading="lazy" src="<?php echo e(asset('public/newpublic/images/usp4.svg')); ?>" alt="usp" height="60" width="60">
            ...
            <div class="usp_grid_box">
                ...
                <img loading="lazy" src="<?php echo e(asset('public/newpublic/images/usp5.svg')); ?>" alt="usp" height="60" width="60">
            ...
            <div class="usp_grid_box">
                ...
                <img loading="lazy" src="<?php echo e(asset('public/newpublic/images/usp6.svg')); ?>" alt="usp" height="60" width="60">
    ...
    <div class="ym-container">
        <div class="home_rating_head">
            ...
            <div class="overall_rating">
                <span class="rating_number"><?php echo e($data['avgRating']); ?></span>
                ...
                <span class="rating_count"><?php echo e($data['reviewCount']); ?> reviews</span>
            </div>
        </div>
            ...
            <?php $__currentLoopData = $data['reviews']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $review): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="rating_card">
                    <div class="rating_card_top">
                        <?php if($review->image): ?>
                        <img src="<?php echo e(asset('public/reviews/'.$review->image)); ?>" alt="<?php echo e($review->customer_name); ?>">
                    <?php else: ?>
                        <?php
                        ...
                        ?>
                        <div class="avatar-initials" style="background-color: <?php echo e($bgColor); ?>;">
                            <?php echo e($initials); ?>

                        </div>
                    <?php endif; ?>
                        <div>
                            <h4><?php echo e($review->customer_name); ?></h4>
                            <div class="card_star">
                    ...
                    <!--<p><?php echo e($review->review_text); ?></p>-->
                     <p class="review-text">
                        ...
                        <span class="read-more"
                              ...
                              title="<?php echo e($review->review_text); ?>">
                            Read More
                        </span>
                    </p>
                </div>
        ...
        <div class="home_customer">
            ...
            <div>
                ...
                <div class="cus_slide">
                    ...
                    <img loading="lazy" src="<?php echo e(asset('public/newpublic/images/otsuka.png')); ?>" alt="otsuka" class="img-fluid">
            ...
            <div>
                ...
                <div class="cus_slide">
                    ...
                    <img loading="lazy" src="<?php echo e(asset('public/newpublic/images/ongc.png')); ?>" alt="ongc" class="img-fluid">
            ...
            <div>
                ...
                <div class="cus_slide">
                    ...
                    <img loading="lazy" src="<?php echo e(asset('public/newpublic/images/hp.png')); ?>" alt="hp" class="img-fluid">
            ...
            <div>
                ...
                <div class="cus_slide">
                    ...
                    <img loading="lazy" src="<?php echo e(asset('public/newpublic/images/murugappa.png')); ?>" alt="murugappa" class="img-fluid">
            ...
            <div>
                ...
                <div class="cus_slide">
                    ...
                    <img loading="lazy" src="<?php echo e(asset('public/newpublic/images/rswm.png')); ?>" alt="rswm" class="img-fluid">
            ...
            <div>
                ...
                <div class="cus_slide">
                    ...
                    <img loading="lazy" src="<?php echo e(asset('public/newpublic/images/abd.png')); ?>" alt="abd" class="img-fluid">
            ...
            <div>
                ...
                <div class="cus_slide">
                    ...
                    <img loading="lazy" src="<?php echo e(asset('public/newpublic/images/gfl.png')); ?>" alt="gfl" class="img-fluid">
            ...
            <div>
                ...
                <div class="cus_slide">
                    ...
                    <img loading="lazy" src="<?php echo e(asset('public/newpublic/images/ramdev.png')); ?>" alt="ramdev" class="img-fluid">
            ...
            <div>
                ...
                <div class="cus_slide">
                    ...
                    <img loading="lazy" src="<?php echo e(asset('public/newpublic/images/rspl.png')); ?>" alt="rspl" class="img-fluid">
            ...
            <div>
                ...
                <div class="cus_slide">
                    ...
                    <img loading="lazy" src="<?php echo e(asset('public/newpublic/images/indian-oil.png')); ?>" alt="indian-oil" class="img-fluid">
            ...
            <div>
                ...
                <div class="cus_slide">
                    ...
                    <img loading="lazy" src="<?php echo e(asset('public/newpublic/images/reliance.png')); ?>" alt="reliance" class="img-fluid">
            ...
            <div>
                ...
                <div class="cus_slide">
                    ...
                    <img loading="lazy" src="<?php echo e(asset('public/newpublic/images/adani.png')); ?>" alt="adani" class="img-fluid">
            ...
            <div>
                ...
                <div class="cus_slide">
                    ...
                    <img loading="lazy" src="<?php echo e(asset('public/newpublic/images/bayer.png')); ?>" alt="bayer" class="img-fluid">
...
<section class="mt-100">
    ...
    <div class="ym-container">
        ...
        <div class="home_blogslider">
            ...
            <?php $__currentLoopData = $data['blog']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $val): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                ...
                <div class="home_blog_slide">
                    ...
                    <div class="blog_card">
                        ...
                        <div>
                            ...
                            <img loading="lazy" src="<?php echo e(asset('public/blog/'.$val->image)); ?>" alt="<?php echo e($val->alt_banner); ?>" class="img-fluid">

                        </div>

                        <div class="blog_card_info">

                            <h3 class="title_24"><?php echo e($val->title); ?></h3>

                            <p><?php echo $val->short_description; ?></p>

                            <a href="<?php echo e(url('/blogdetail/'.$val->url)); ?>" target="_blank" class="btn_3 btn_2">
        ...
        <div class="modal-content" style="background: transparent; border: none;">
            ...
            <div class="modal-body p-0">
                ...
                <video muted loop playsinline class="w-100 d-none d-lg-block promoVideo" id="desktopVideo" preload="auto">
                    ...
                    <source src="<?php echo e(asset('public/newpublic/images/mmp-filter-home-page-video.mp4')); ?>" type="video/mp4">
                ...
                <video muted loop playsinline class="w-100 d-lg-none promoVideo" id="mobileVideo" preload="auto" poster="<?php echo e(asset('public/newpublic/images/mmp-filter-home-page-video-phone.png')); ?>">

                    <source src="<?php echo e(asset('public/newpublic/images/mmp-filter-home-page-video-phone.mp4')); ?>" type="video/mp4">
...
<?php echo $__env->make('layouts.frontfooterlinks', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
<?php /**PATH C:\Intelliworkz\mmp\resources\views/front/dashboard.blade.php ENDPATH**/ ?>