...
<div class="WhatsAppButton_mpp">
  <div class="whatsapp_img">
    ...
    <div class="whatsapp-popup" id="whatsappPopup">
      ...
      <form class="wa_form" method="POST" action="<?php echo e(route('whatsaapinquiry')); ?>" id="whatsappForm" target="_blank">
        <?php echo csrf_field(); ?>
    ...
    <img src="<?php echo e(asset('public/newpublic/images/whatsapp.png')); ?>" id="whatsappBtn" alt="whatsapp">
  </div>
</div>
...
<?php /**PATH C:\Intelliworkz\mmp\resources\views/layouts/whatsapppoup.blade.php ENDPATH**/ ?>