...
<!-- End Google Tag Manager -->
    ...
    <link href="<?php echo e(asset('public/front/images/favicon.png')); ?>" rel="icon">
...
<?php else: ?>
    ...
    <link rel="stylesheet" href="<?php echo e(asset('public/front/css/slick.css')); ?>?v=<?php echo e(time()); ?>" />

    <link rel="stylesheet" href="<?php echo e(asset('public/front/css/slick-theme.css')); ?>?v=<?php echo e(time()); ?>" />

    <link rel="stylesheet" href="<?php echo e(asset('public/front/css/fancybox.min.css')); ?>?v=<?php echo e(time()); ?>" />

    <link rel="stylesheet" href="<?php echo e(asset('public/front/css/mmp.style.css')); ?>?v=<?php echo e(time()); ?>" />

    <link rel="stylesheet" href="<?php echo e(asset('public/front/css/mmp.responsive.css')); ?>?v=<?php echo e(time()); ?>" />
...
<?php endif; ?>
    ...
    <!-- css -->
     ...
     <link rel="stylesheet" href="<?php echo e(asset('public/newpublic/css/offcanvas.css')); ?>">

    <link rel="stylesheet" href="<?php echo e(asset('public/newpublic/css/header.css')); ?>">

    <link rel="stylesheet" href="<?php echo e(asset('public/newpublic/css/header_responsive.css')); ?>">

    <link rel="stylesheet" href="<?php echo e(asset('public/newpublic/css/style.css')); ?>">

    <link rel="stylesheet" href="<?php echo e(asset('public/newpublic/css/responsive.css')); ?>">

    <link rel="stylesheet" href="<?php echo e(asset('public/newpublic/css/footer.css')); ?>">
    ...
    <?php if(!empty($og_image)): ?>
        ...
        <meta property="og:image" content="<?php echo e(asset('public/blog_og_image/' . $blogdetail->og_image)); ?>" />

    <?php elseif(!empty($data['products']->mobile_image)): ?>

     <meta property="og:image" content="<?php echo e(asset('public/Product_Mobile_Images/'.$data['products']->mobile_image)); ?>" />

    

    <?php else: ?>

         <meta property="og:image" content="<?php echo e(isset($ogimage) ? $ogimage : asset('public/front/images/air-filters.png')); ?>" />
...
<body>
    ...
    <?php if(request()->is('liquid-bag')): ?>

        <header>

    <?php else: ?>

        <header class="<?php echo e(request()->is('/') ? '' : 'is-white'); ?>">
    ...
    <?php endif; ?>
        ...
        <div class="header-container">
            ...
            <nav>
                 ...
                 <?php echo $__env->make('layouts.new_frontheader', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
document.addEventListener("DOMContentLoaded", function () {
    ...
    <main>
        ...
        <!--                        <a href="<?php echo e(route('partnership')); ?>">Partnership Opportunities</a>-->

        <!--                    </li>-->

        <!--                    <li>-->

        <!--                        <a href="<?php echo e(route('machinery')); ?>">Videos</a>-->

        <!--                    </li>-->

        <!--                    <li>-->

        <!--                        <a href="<?php echo e(route('certifications')); ?>">Certifications</a>-->
        ...
        <!--                        <?php $category = $categoryGroup->first(); ?>-->
        ...
        <!--                                    <?php $__currentLoopData = $categoryGroup; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>-->

        <!--                                        <?php if($product->product_id): ?>-->

                    

        <!--                                            <?php if(strtolower(trim($product->product_name)) == 'wound filter cartridge machine'): ?>-->
        ...
        <!--                                                    <a href="<?php echo e(route('productdetail', ['url' => $product->producturl])); ?>">-->
        ...
        <!--                                    <?php if($category->category_url == 'water-filter-cartridges'): ?>-->
        ...
        <!--                    <li><a href="<?php echo e(url('/food-and-beverage-industry')); ?>">Food and Beverage Industry</a></li>-->
        ...
        <!--                    <li><a href="<?php echo e(url('/oil-and-gas-industry')); ?>">Oil and Gas Industry</a></li>-->
        ...
        <!--                    <li><a href="<?php echo e(route('casestudy')); ?>">Case Study</a></li>-->
    ...
    link.addEventListener('click', function (e) {
        ...
        <!-- header scripts --><?php /**PATH C:\Intelliworkz\mmp\resources\views/layouts/frontheader.blade.php ENDPATH**/ ?>