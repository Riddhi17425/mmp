            ...
            <div class="top_footer_grid">
                <div>
                    ...
                    <ul class="ft_list">
                        ...
                        <li><a href="{{ asset('public/front/images/mmp-master-brochure-2025.pdf') }}" target="_blank">E-Catalogue</a></li>
            ...
            <div class="extended-footer" id="extendedFooter">
                <div class="extended-content">
                    <div class="extended-links">
                        ...
                        <a href="{{ route('melt-blown-filter-cartridges-in-usa') }}">Melt Blown Filter Cartridges in USA</a>
                        ...
                        <a href="{{ route('wound-filter-cartridges-machine-in-usa') }}">Wound Filter Cartridges Machine in USA</a>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="ym-container">
        <div class="btm_mid_wraper">
            <div class="ft_logo">
                ...
                <div>
                    <img src="{{ asset('public/newpublic/images/ft_logo.svg') }}" alt="mmp" width="183" height="55">
                     <div class="ft_social">
