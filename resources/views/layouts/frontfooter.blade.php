    ...
    <div class="top_footer_wrapper">
        <div class="ym-container">
            <div class="top_footer_grid">
                <div>
                    ...
                    <ul class="ft_list">
                        ...
                        <li><a href="{{ route('partnership') }}">Partnership Opportunities</a></li>
                        <li><a href="{{ asset('public/front/images/mmp-master-brochure-2025.pdf') }}"
                                target="_blank">E-Catalogue</a></li>
                ...
                <div>
                    ...
                    <ul class="ft_list">
                        ...
                        @endforeach
                        <li><a href="{{ route('woundfiltercartridgemachine') }}">Wound Filter Cartridge Machine</a></li>
                    </ul>
                </div>
                <div>
                ...
                <div>
                    ...
                    <ul class="ft_list">
                        ...
                        <li><a href="{{ url('/food-and-beverage-industry') }}">Food & Beverage Industry</a></li>
                ...
                <div>
                    ...
                    <ul class="ft_list">
                        ...
                        <li><a href="{{ url('/oil-and-gas-industry') }}">Oil & Gas Industry</a></li>
            ...
            <div class="row mb-4 mt-5">
                <div class="col-lg-4">
                    <div>
                        <h4 class="ft_head">Get in Touch <img class="ms-3" src="https://italy.mmpfilter.com/public/front/images/india_flag.png" alt=""></h4>
                        <ul class="ft_list">
                            <li>
                                <div class="ft_link">
                                    ...
                                    <a style="flex:1;"
                                        href="https://www.google.com/maps/search/C3-602+Anushruti+Tower,+SG+Road,+Thaltej,+Ahmedabad+%E2%80%93+380059+Gujarat,+India/@23.053608,72.5150764,17z/data=!3m1!4b1?entry=ttu">C3-602
                                        Anushruti Tower,
                                        SG Road, Thaltej,
                                        Ahmedabad – 380059
                                        Gujarat, India</a>
                ...
                <div class="col-lg-4">
                    <div>
                        <h4 class="ft_head">Get in Touch <img class="ms-3" src="https://italy.mmpfilter.com/public/front/images/italy_flag.png" alt=""></h4>
                        <ul class="ft_list">
                            <li>
                                <div class="ft_link">
                                    <svg width="16" height="21" viewBox="0 0 16 21" fill="none"
                            ...
                            <li>
                                <div class="ft_link">
                                    ...
                                    <a href="mailto:sales@mmpfilter.com">m.radice@mffiltri.com</a>
                                </div>
                            </li>
                            <li>
                                <div class="ft_link">
                                    ...
                                    <a href="tel:919830030614">+39 3286959896</a>
                                </div>
                            </li>
                        </ul>
            ...
            <div class="mmp-globally-toggle" id="toggleButton">
                <span class="ft_head">
                    ...
                    <span class="toggle-arrow ms-2" id="toggleArrow">
                        <svg width="20" height="8" viewBox="0 0 20 11" fill="none"
                            xmlns="http://www.w3.org/2000/svg">
            ...
            <div class="extended-footer" id="extendedFooter">
                <div class="extended-content">
                    <div class="extended-links">
                        <a href="{{ route('filter-cartridges-in-usa') }}">Filter Cartridges in USA</a>
                        <a href="{{ route('melt-blown-filter-cartridges-in-usa') }}">Melt Blown Filter Cartridges in
                            USA</a>
                        <a href="{{ route('pp-filtration-yarn-in-usa') }}">PP Filtration Yarn in USA</a>
                        <a href="{{ route('wound-filter-cartridges-in-usa') }}">Wound Filter Cartridges in USA</a>
                        <a href="{{ route('wound-filter-cartridges-machine-in-usa') }}">Wound Filter Cartridges
                            Machine in USA</a>
                    </div>
                </div>
            </div>
    ...
    <div class="ym-container">
        <div class="btm_mid_wraper">
            <div class="ft_logo">
                ...
                <div>
                    <img src="{{ asset('public/newpublic/images/ft_logo.svg') }}" alt="mmp" width="183"
                        height="55">
                    <div class="ft_social">
            ...
            <div class="ft_trademarks">
                ...
                <div>
                    <img src="{{ asset('public/newpublic/images/nsf.webp') }}" alt="" width="130px">
                    <p>MB OCEANIC<span style="font-size:30px;">&#174;</span> & LAGOON<span
...
@include('layouts.whatsapppoup')
@include('layouts.enquire-poup')
