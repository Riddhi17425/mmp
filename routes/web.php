...
Route::fallback(function () { return 'Fallback: Path = ' . request()->path() . ' | Method = ' . request()->method(); });

Route::fallback(function () { file_put_contents('fallback_log.txt', request()->path() . ' ' . request()->method() . PHP_EOL, FILE_APPEND); return 'fallback'; });
